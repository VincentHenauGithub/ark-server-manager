...
CONFIG = [
    { "enabled": True,  "type": "land",  "path": "skippy",   "added_levels": 38,  "base_levels": 255, "difficulty_level": 7,  "mixed": False , "blueprint": Classes.dinos.non_tameable.alpha.alpha_raptor       },
...
class DinoBossManager(Manager):
    ...
    def main(self):
        ...
        if self.menagerie_state.number_active == 0 and time.localtime().tm_hour == 5:
            ...
            while self.menagerie_state.number_active < 5:
                mem = self.spawn_new()
